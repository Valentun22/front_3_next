...
const VenueInfo: FC<IProps> = ({name, rating = 0, type, description, location, features, averageCheck, workingHours, contactInfo, menu}) => {
            ...
            <div className={css.info}>
                <div className={css.infoBoxAll}>
                    ...
                    <div className={css.map}>
                        <img src={"https://www.google.com/maps/about/images/mymaps/mymaps-desktop-16x9.png"}
                             alt={name}/>
                    </div>
                </div>
            </div>
