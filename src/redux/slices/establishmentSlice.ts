...
import {venueService} from "@/services/establishment.service";

interface IState {
    data: { venues: IEstablishment[], count: number, maxCheck: number },
    dataByUser: {venues: IEstablishment[], count: 0}
}
